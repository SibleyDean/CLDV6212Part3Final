...
public class FunctionsApiClient : IFunctionsApi
{
    ...
    public async Task<Customer> CreateCustomerAsync(Customer c)  // Should be CreateCustomerAsync
     ...
     public async Task<Customer> UpdateCustomerAsync(string id, Customer c)  // Should be UpdateCustomerAsync
